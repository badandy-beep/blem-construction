    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', color: '#1C2B39', paddingTop: '120px' }}>
      <section style={{ padding: '60px 5%', backgroundColor: '#F8F6F3' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', textAlign: 'center' }}>
          <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '52px', fontWeight: 600, color: '#1C2B39', marginBottom: '20px' }}>Contact Us</h1>
          <p style={{ fontSize: '18px', color: '#4A5568', maxWidth: '600px', margin: '0 auto' }}>Ready to build your legacy? Schedule a free consultation with Mike today.</p>
        </div>
      </section>
      ...
      <section style={{ padding: '80px 5%', backgroundColor: '#FFFFFF' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div className="grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px' }}>
            <div>
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '32px', fontWeight: 600, color: '#1C2B39', marginBottom: '32px' }}>Get In Touch</h2>
              ...
              <div style={{ marginBottom: '32px' }}>
                ...
                <a href="tel:9417772536" style={{ fontSize: '36px', color: '#1C2B39', textDecoration: 'none', fontFamily: "'Playfair Display', Georgia, serif" }}>(941) 777-BLEM</a>
              ...
              <div style={{ marginBottom: '32px' }}>
                ...
                <a href="mailto:mike@blemconstruction.com" style={{ fontSize: '20px', color: '#1C2B39', textDecoration: 'none', fontFamily: "'Montserrat', sans-serif", fontWeight: 500 }}>mike@blemconstruction.com</a>
              </div>
              ...
              <div style={{ display: 'flex', gap: '32px', marginTop: '40px', paddingTop: '40px', borderTop: '1px solid #E5E7EB' }}>
                <div>
            ...
            <div style={{ backgroundColor: '#F8F6F3', padding: '48px', borderRadius: '16px' }}>
              <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '24px', fontWeight: 600, color: '#1C2B39', marginBottom: '32px' }}>Request a Quote</h3>
              <form>
                <div style={{ marginBottom: '24px' }}>
                  ...
                  <input type="text" required placeholder="Your Name" style={{ width: '100%', padding: '18px', border: '1px solid #E5E7EB', fontSize: '16px', fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', outline: 'none', boxSizing: 'border-box', borderRadius: '8px' }} />
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
                  <div>
                    ...
                    <input type="email" required placeholder="Email" style={{ width: '100%', padding: '18px', border: '1px solid #E5E7EB', fontSize: '16px', fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', outline: 'none', boxSizing: 'border-box', borderRadius: '8px' }} />
                  </div>
                  <div>
                    ...
                    <input type="tel" placeholder="Phone" style={{ width: '100%', padding: '18px', border: '1px solid #E5E7EB', fontSize: '16px', fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', outline: 'none', boxSizing: 'border-box', borderRadius: '8px' }} />
                  </div>
                </div>
                <div style={{ marginBottom: '24px' }}>
                  ...
                  <select value={projectType} onChange={(e) => setProjectType(e.target.value)} style={{ width: '100%', padding: '18px', border: '1px solid #E5E7EB', fontSize: '16px', fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', outline: 'none', boxSizing: 'border-box', borderRadius: '8px' }}>
                ...
                <div style={{ marginBottom: '24px' }}>
                  ...
                  <textarea required rows="4" placeholder="Tell us about your project..." style={{ width: '100%', padding: '18px', border: '1px solid #E5E7EB', fontSize: '16px', fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', outline: 'none', resize: 'vertical', boxSizing: 'border-box', borderRadius: '8px' }} />
                </div>
                <button type="submit" style={{ width: '100%', backgroundColor: '#1C2B39', color: '#FFFFFF', padding: '20px 32px', border: 'none', fontFamily: "'Montserrat', sans-serif", fontSize: '13px', letterSpacing: '3px', cursor: 'pointer', fontWeight: 700, textTransform: 'uppercase', borderRadius: '8px' }}>Request Free Consultation</button>
              </form>
            </div>
          </div>
        </div>
