  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', color: '#1C2B39', overflowX: 'hidden' }}>
      ...
      <section style={{ 
        ...
        padding: rs('160px 5% 100px', '120px 16px 60px'), 
        position: 'relative', 
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '1400px', margin: '0 auto', width: '100%' }}>
          ...
          <h1 style={{ 
            ...
            fontSize: rs('56px', '32px'), 
            fontWeight: 600, 
            color: '#FFFFFF', 
            marginBottom: rs('24px', '16px'), 
            lineHeight: 1.15, 
            maxWidth: '850px' 
          }}>
          ...
          <p style={{ 
            fontSize: rs('20px', '16px'), 
            color: 'rgba(255,255,255,0.9)', 
            maxWidth: '700px', 
            marginBottom: rs('32px', '24px'), 
            lineHeight: 1.8, 
            fontWeight: 300 
          }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div style={{ display: 'flex', gap: rs('16px', '12px'), flexWrap: 'wrap' }}>
              <Link href="/commercial" style={{ 
                ...
                color: '#FFFFFF', 
                padding: rs('18px 32px', '14px 20px'), 
                textDecoration: 'none', 
          ...
          {/* License Info - Hide on very small mobile */}
      ...
      <section style={{ padding: rs('100px 5%', '60px 16px'), backgroundColor: '#FFFFFF' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          {/* Factoid Box */}
          <div style={{ 
            background: 'linear-gradient(135deg, #1C2B39 0%, #243342 100%)', 
            padding: rs('28px 32px', '20px 16px'), 
            borderRadius: '12px', 
            borderLeft: '4px solid #D4A012', 
            display: 'flex', 
            ...
            <div>
              ...
              <p style={{ fontSize: rs('14px', '13px'), color: 'rgba(255,255,255,0.7)', margin: '8px 0 0 0' }}>Like charter schools vs. public—better value through personalized attention and lean operations.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: rs('1fr 1fr', '1fr'), gap: rs('40px', '24px') }}>
            <Link href="/commercial" style={{ textDecoration: 'none' }}>
              <div style={{ backgroundColor: '#FFFFFF', padding: rs('50px', '24px'), borderRadius: '16px', border: '1px solid #E5E7EB', boxShadow: '0 8px 40px rgba(28,43,57,0.08)', transition: 'all 0.3s ease', borderTop: '4px solid #64748B' }}>
            ...
            <Link href="/residential" style={{ textDecoration: 'none' }}>
              <div style={{ backgroundColor: '#FFFFFF', padding: rs('50px', '24px'), borderRadius: '16px', border: '1px solid #E5E7EB', boxShadow: '0 8px 40px rgba(28,43,57,0.08)', transition: 'all 0.3s ease', borderTop: '4px solid #6B8E73' }}>
      ...
      <section style={{ padding: rs('100px 5%', '60px 16px'), backgroundColor: '#1C2B39' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ 
            marginTop: rs('50px', '30px'), 
            textAlign: 'center', 
            padding: rs('32px', '20px 16px'), 
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: rs('50px', '30px') }}>
            <Link href="/projects" style={{ 
              ...
              color: '#FFFFFF', 
              padding: rs('18px 40px', '16px 32px'), 
              textDecoration: 'none', 
              fontFamily: "'Montserrat', sans-serif", 
              fontSize: '13px', 
              letterSpacing: '2px', 
      ...
      <section style={{ padding: rs('100px 5%', '60px 16px'), backgroundColor: '#F8F6F3' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ 
            fontFamily: "'Playfair Display', Georgia, serif", 
            fontSize: rs('26px', '18px'), 
            color: '#1C2B39', 
            lineHeight: 1.6, 
            marginBottom: rs('40px', '24px'), 
            fontStyle: 'italic',
            padding: rs('0', '0 8px'),
          }}>"{testimonials[activeTestimonial].quote}"</div>
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), backgroundColor: '#B8860B' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <Link href="/contact" style={{ 
            ...
            backgroundColor: '#1C2B39', 
            color: '#FFFFFF', 
            padding: rs('20px 50px', '16px 32px'), 
            textDecoration: 'none', 
            fontFamily: "'Montserrat', sans-serif", 
            fontSize: '13px', 
            letterSpacing: rs('3px', '2px'), 
            fontWeight: 700, 
            textTransform: 'uppercase', 
            borderRadius: '8px' 
