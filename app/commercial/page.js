...
import { projects, testimonials, commercialBenefits, faqData } from '@/lib/data';
    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', color: '#1C2B39', paddingTop: rs('120px', '100px') }}>
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), background: 'linear-gradient(145deg, #1C2B39 0%, #243342 100%)' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: rs('18px', '15px'), color: 'rgba(255,255,255,0.8)', maxWidth: '800px', margin: '0 auto', lineHeight: 1.7 }}>For industrial, commercial, and municipal clients demanding ROI, compliance, and minimal downtime. Save 15-20% with our tech-driven approach.</p>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: rs('1fr 1fr', '1fr'), gap: rs('60px', '30px'), alignItems: 'center' }}>
            <div>
              ...
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('36px', '26px'), fontWeight: 600, color: '#1C2B39', marginTop: '12px', marginBottom: '24px' }}>Build From the Ground Up</h2>
              <p style={{ fontSize: rs('16px', '14px'), color: '#4A5568', lineHeight: 1.8, marginBottom: '32px' }}>From hotels and medical facilities to municipal infrastructure, we deliver large-scale commercial projects with precision, compliance, and value engineering.</p>
              
              {/* Benefits List */}
              <div style={{ marginBottom: '32px' }}>
                {commercialBenefits.newConstruction.slice(0, 4).map((benefit, i) => (
            ...
            <div style={{ backgroundColor: '#F8F6F3', padding: rs('40px', '24px'), borderRadius: '16px', borderLeft: '4px solid #64748B' }}>
              ...
              <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('24px', '20px'), fontWeight: 600, color: '#1C2B39', marginBottom: '16px' }}>Commercial & Medical</h3>
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), backgroundColor: '#F8F6F3' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('36px', '26px'), fontWeight: 600, color: '#1C2B39', marginBottom: '40px', textAlign: 'center' }}>Commercial Projects Portfolio</h2>
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), backgroundColor: '#FFFFFF' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('36px', '26px'), fontWeight: 600, color: '#1C2B39', marginBottom: '40px', textAlign: 'center' }}>Commercial FAQ</h2>
            ...
            {faqData.commercial.general.map((faq, i) => (
              <div key={i} style={{ borderBottom: '1px solid #E5E7EB' }}>
                <button 
                  ...
                  style={{ width: '100%', padding: rs('24px 0', '20px 0'), display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'none', border: 'none', cursor: 'pointer', fontFamily: "'Outfit', sans-serif", fontSize: rs('18px', '15px'), fontWeight: 500, color: '#1C2B39', textAlign: 'left', gap: '16px' }}
                >
                ...
                {openFaq === i && (
                  <div style={{ padding: '0 0 24px 0', fontSize: rs('16px', '14px'), lineHeight: 1.8, color: '#4A5568' }}>
                    {faq.answer}
                  </div>
                )}
              </div>
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), backgroundColor: '#64748B' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: rs('18px', '15px'), color: 'rgba(255,255,255,0.9)', marginBottom: '32px', maxWidth: '600px', margin: '0 auto 32px' }}>Let's discuss how we can deliver your project under budget and on time.</p>
          <Link href="/contact" style={{ display: 'inline-block', backgroundColor: '#1C2B39', color: '#FFFFFF', padding: rs('20px 50px', '16px 32px'), textDecoration: 'none', fontFamily: "'Montserrat', sans-serif", fontSize: '13px', letterSpacing: rs('3px', '2px'), fontWeight: 700, textTransform: 'uppercase', borderRadius: '8px' }}>Inquire About Commercial Partnerships</Link>
        </div>
      </section>
    </div>
  );
