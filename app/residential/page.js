...
import { projects, residentialBenefits, faqData } from '@/lib/data';
  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', paddingTop: rs('120px', '100px') }}>
      <section style={{ padding: rs('80px 5%', '50px 16px'), background: 'linear-gradient(145deg, #1C2B39 0%, #243342 100%)' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: rs('60px', '24px'), marginTop: '50px', flexWrap: 'wrap' }}>
            {[{ num: '200+', label: 'Homes Completed' }, { num: '98%', label: 'Budget Adherence' }, { num: '50%', label: 'Lower Overhead' }].map((stat, i) => (
              <div key={i}>
                <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('42px', '28px'), fontWeight: 600, color: '#6B8E73' }}>{stat.num}</div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: rs('1fr 1fr', '1fr'), gap: rs('60px', '30px'), alignItems: 'center' }}>
            <div>
              ...
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('36px', '26px'), fontWeight: 600, marginTop: '12px', marginBottom: '24px' }}>Build Your Dream Home</h2>
              ...
              <div style={{ marginBottom: '32px' }}>
                {residentialBenefits.newConstruction.slice(0, 4).map((b, i) => (
            ...
            <div style={{ backgroundColor: '#F8F6F3', padding: rs('40px', '24px'), borderRadius: '16px', borderLeft: '4px solid #6B8E73' }}>
              ...
              <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('24px', '20px'), fontWeight: 600, marginBottom: '16px' }}>Custom Homes</h3>
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), backgroundColor: '#F8F6F3' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('36px', '26px'), fontWeight: 600, marginBottom: '40px', textAlign: 'center' }}>Residential Projects</h2>
          {isMobile ? (
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), backgroundColor: '#FFFFFF' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('36px', '26px'), fontWeight: 600, marginBottom: '24px', textAlign: 'center' }}>Residential FAQ</h2>
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), backgroundColor: '#6B8E73' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <Link href="/contact" style={{ display: 'inline-block', backgroundColor: '#1C2B39', color: '#FFFFFF', padding: '16px 32px', textDecoration: 'none', fontFamily: "'Montserrat', sans-serif", fontSize: '13px', letterSpacing: '2px', fontWeight: 700, textTransform: 'uppercase', borderRadius: '8px' }}>Get Your Free Quote</Link>
        </div>
      </section>
    </div>
  );
