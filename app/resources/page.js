    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", backgroundColor: '#FFFFFF', paddingTop: rs('120px', '100px') }}>
      <section style={{ padding: rs('60px 5%', '40px 16px'), backgroundColor: '#F8F6F3' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', textAlign: 'center' }}>
          <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('52px', '32px'), fontWeight: 600, marginBottom: '20px' }}>Industry Resources</h1>
      ...
      <section style={{ padding: rs('80px 5%', '50px 16px'), backgroundColor: '#FFFFFF' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: rs('1fr 1fr', '1fr'), gap: rs('60px', '40px') }}>
            <div>
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('32px', '24px'), fontWeight: 600, marginBottom: '32px', borderBottom: '3px solid #64748B', paddingBottom: '16px' }}>Commercial Resources</h2>
            ...
            <div>
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('32px', '24px'), fontWeight: 600, marginBottom: '32px', borderBottom: '3px solid #6B8E73', paddingBottom: '16px' }}>Residential Resources</h2>
      ...
      <section style={{ padding: rs('60px 5%', '40px 16px'), backgroundColor: '#F8F6F3' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: rs('28px', '22px'), fontWeight: 600, marginBottom: '32px', textAlign: 'center' }}>General Resources</h2>
