...
// NOW HIRING SECTION - Navy SEALs of Construction
export const hiringData = {
  headline: "Join the Navy SEALs of Construction",
  description: "Michael Blem Construction is growing rapidly, fueled by our 40+ years of excellence and commitment to integrity. We exercise the utmost discernment in hiring—seeking elite professionals who embody precision, teamwork, and unwavering standards, much like the Navy SEALs. We're the elite force in Southwest Florida construction, tackling complex projects with unmatched expertise.",
  positions: [
    {
      title: "Architect",
      description: "Design innovative residential and commercial structures that stand the test of time and Florida weather."
    },
    {
      title: "Project Manager",
      description: "Oversee high-impact builds with AI integration, ensuring on-time, under-budget delivery."
    },
    {
      title: "Site Superintendent",
      description: "Lead on-site operations with precision, managing trades and ensuring quality at every step."
    },
    {
      title: "Subcontractor Opportunities",
      description: "Apply to join our vetted network for plumbing, electrical, HVAC, and specialty trades."
    }
  ],
  disclaimer: "Michael Blem Construction is an equal opportunity employer. All applicants will be considered without regard to race, color, religion, sex, national origin, disability, or veteran status. We comply with all federal, state, and local laws. Employment is at-will. Background checks and drug screening required."
};
